...
public class ConnectorIntegrationUtil {
    ...
    public static int sendRequestToRetriveHeaders(String addUrl, String query) throws IOException, JSONException {
        ...
        connection.setRequestProperty("Accept-Charset", ConnectorIntegrationConstant.CHARSET);
        connection.setRequestProperty("Content-Type", "application/json;charset=" + ConnectorIntegrationConstant.CHARSET);
        OutputStream output = null;
        try {
            output = connection.getOutputStream();
            output.write(query.getBytes(ConnectorIntegrationConstant.CHARSET));
        } finally {
            if (output != null) {
                try {
                    output.close();
    ...
    public static int sendRequestToRetriveHeaders(String addUrl, String query, String contentType) throws IOException,
        ...
        connection.setDoOutput(true);
        connection.setRequestProperty("Accept-Charset", ConnectorIntegrationConstant.CHARSET);
        connection.setRequestProperty("Content-Type", contentType + ";charset=" + ConnectorIntegrationConstant.CHARSET);
        OutputStream output = null;
        try {
            output = connection.getOutputStream();
            output.write(query.getBytes(ConnectorIntegrationConstant.CHARSET));
    ...
    public static String sendRequestString(String addUrl, String query) throws IOException, JSONException {
        URLConnection connection = new URL(addUrl).openConnection();
        connection.setDoOutput(true);
        connection.setRequestProperty("Accept-Charset", ConnectorIntegrationConstant.CHARSET);
        connection.setRequestProperty("Content-Type", "application/json;charset=" + ConnectorIntegrationConstant.CHARSET);
